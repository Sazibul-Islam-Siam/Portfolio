        ...
        <div className="about-grid">
          <div className="about-image reveal">
            <div className="image-frame">
              <img src="/siam.png" alt="Sazibul Islam Siam — ML Researcher and Developer" className="profile-img" />
          ...
          <div className="about-text reveal">
            ...
            <div className="about-stats" ref={statsRef}>
              ...
              <div className="stat">
                <span className="stat-number" data-target="5">0</span><span className="stat-suffix">+</span>
